...
public class GPResourceGroupActivityDTO implements ResourceDTO {
  ...
  /**
   * type	      references	        description
   * text	 	                        Current remoteStatement that process is running
   */
  ...
  /**
   * type	      references	        description
   * timestamptz	 	                  Time remoteStatement began execution
   */
  ...
  /**
   * type	      references	        description
   * interval	 	                    For a queued remoteStatement, the total time the remoteStatement has been queued.
   */
